...
<div class="container container-star">
    ' . str_repeat("<div class=star-1></div>", 30) .
            str_repeat("<div class=star-2></div>", 30) . '
</div>
<div class="container container-bird">
    ' . str_repeat('<div class="bird bird-anim">
...
<div class="container-title">
    ...
    <div class="subtitle rtl">لینک مورد نظر یافت نشد!</div>
    <a href="./" class="rtl"><button>بازگشت</button></a>
</div>
</div>';
